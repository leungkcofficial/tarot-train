"""
Final ensemble pipeline that combines stacked DeepSurv and DeepHit predictions.
...
3. Combines all 24 predictions using simple averaging
...
from steps.evaluate_ensemble_combinations_parallel import evaluate_ensemble_combinations_parallel
...
def final_ensemble_pipeline():
    """Final ensemble pipeline combining all predictions."""
    ...
    # ==================== Ground truth duration and event labelling ====================
    # Extract ground truth labels from test sets
    ...
    # ==================== Ensemble and Evaluate Predictions ====================
    # Evaluate different ensemble combinations using parallel processing
    evaluation_results = evaluate_ensemble_combinations_parallel(
        ...
        max_combinations=1000,  # Evaluate more combinations for better coverage
